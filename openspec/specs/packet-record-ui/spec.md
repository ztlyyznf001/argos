# packet-record-ui Specification

## Purpose

定义 Inspector 的抓包记录界面：列表页的摘要展示、搜索与 Method 过滤、路由分组与抓包开关，详情页的请求/响应分离、Header 与 Query Params 展示、错误请求提示，以及清空记录、实时刷新、复制为 cURL 等交互能力。
