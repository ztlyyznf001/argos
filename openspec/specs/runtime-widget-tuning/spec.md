# runtime-widget-tuning Specification

## Purpose

Define the opt-in runtime widget tuning API, safe value retention and validation, long-press target discovery, compact numeric and color editing controls, and the ephemeral behavior of tuning state.
